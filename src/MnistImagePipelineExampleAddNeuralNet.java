...
public class MnistImagePipelineExampleAddNeuralNet {
    // load data
    //  transform if needed
    public static Logger log = LoggerFactory.getLogger(MnistImagePipelineExampleAddNeuralNet.class);
...
//        recordReader.setListeners(new LogRecordListener());
        ...
        log.info("**** record reader labels for training ****");
        log.info(recordReader.getLabels().toString());

        recordReader.reset();
        recordReader.initialize(test);

        log.info("**** record reader labels for test ****");
        log.info(recordReader.getLabels().toString());
